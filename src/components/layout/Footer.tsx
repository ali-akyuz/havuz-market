    ...
    <footer className="bg-navy-950 text-navy-300">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16 border-b border-navy-800/50">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2.5 group w-fit">
              ...
              <span className="text-xl font-black text-white tracking-tight">arpeta</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-navy-400">Ostim OSB, 100. Yıl Bulvarı No:123<br />Yenimahalle / Ankara</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-turquoise-500 flex-shrink-0" />
                <a href="tel:08501234567" className="text-navy-400 hover:text-turquoise-400 transition-colors">0850 123 45 67</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-turquoise-500 flex-shrink-0" />
                <a href="mailto:destek@arpeta.com.tr" className="text-navy-400 hover:text-turquoise-400 transition-colors">destek@arpeta.com.tr</a>
              </li>
            </ul>
            ...
            <div className="mt-6 p-4 bg-navy-800/40 rounded-2xl border border-navy-700/50">
              ...
              <p className="text-xs text-navy-400">Hft içi 09:00–18:00 | Cts 09:00–14:00</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-6 text-xs text-navy-500">
          <p>© {new Date().getFullYear()} Arpeta E-Ticaret. Tüm hakları saklıdır.</p>
